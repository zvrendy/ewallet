            ...
            <div class="card mb-4">
              <div class="card-header border-0">
                ...
                <div class="card-tools"> <a href="#" class="btn btn-tool btn-sm"> <i class="bi bi-download"></i>
                  </a> <a href="#" class="btn btn-tool btn-sm"> <i class="bi bi-list"></i> </a> </div>
              </div>
              <div class="card-body table-responsive p-0">
                <table class="table table-striped align-middle">
                  ...
                  <tbody>
                    <tr>
                      <td> <img src="{{ asset('adminlte/assets/img/default-150x150.png') }}" alt="Product 1"
          ...
          <div class="col-lg-6">
            ...
            <div class="card">
              <div class="card-header border-0">
                ...
                <div class="card-tools"> <a href="#" class="btn btn-sm btn-tool"> <i class="bi bi-download"></i>
                  </a> <a href="#" class="btn btn-sm btn-tool"> <i class="bi bi-list"></i> </a> </div>
              </div>
              <div class="card-body">
